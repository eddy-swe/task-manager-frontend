      ...
      <div className="w-full max-w-xl p-6">
        ...
        <form onSubmit={handleSubmit} className="mb-6 flex gap-2">
          <input
            ...
            className="flex-1 p-3 border border-gray-200 rounded-lg bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
          <button
            type="submit"
